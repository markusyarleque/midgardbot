        ...
        if(message.content.includes('https://discord.gg/')){
            ...
            try {
                ...
                if(invite.guild){
                    ...
                    embed.setImage(invite.guild.bannerURL() ? invite.guild.bannerURL({ size: 2048 }) : '' )
                    console.log('Banner: ' + invite.guild.bannerURL() + 'banner2.: ' + invite.guild.bannerURL({ size: 2048 }).replace('webp','png') )
