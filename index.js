...
client.on('messageDelete', (message) => {
    ...
    .addField('Mensaje: ', `<a:flech:915156906258071554> ${message.content}`)
    .setColor('RANDOM')
   ...
   message.channel.send({ embeds: [embed] });
    ...
    if(command === 'welcome'){
        ...
        if (!img || img.id===message.author.id) {
            ...
            //.setAuthor(`Midgard`ps://images-ext-2.discordapp.net/external/18X-qDE3JIOunpBItNM1A9YQsvqOq3-EkOwvsNgn76k/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/904290001196556369/e7854088a43de999fb373b4599c5a6d3.png')
