...
module.exports =  {
    ...
    async execute(client, message, args, Discord) {
        ...
        .addField('¿Mencionable?:', `<a:flech:931432469935312937> `+boolean[role.mentionable ? role.mentionable : '0'])
        .addField('¿Separado?:', `<a:flech:931432469935312937> `+boolean[role.hoist ? role.hoist : '0'])
        .addField('¿Gestionado por el sistema?:', `<a:flech:931432469935312937> `+boolean[role.managed ? role.managed : '0']) 
        .setColor('RANDOM')
