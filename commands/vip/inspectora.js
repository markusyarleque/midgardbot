module.exports =  {
    ...
    async execute(client, message, args, Discord) { 
        ...
        .addField('\u200B','\u200B')
        .addField('<:amor:836060720457056267> Nivel de Fidelidad:','<a:flech:915156906258071554> ' + fidelidad + ' %', false)
        ...
        .setImage('https://media.discordapp.net/attachments/939264324692758568/957151279161966602/IMG_4892.jpg?width=360&height=260')
        .setColor('RANDOM')
