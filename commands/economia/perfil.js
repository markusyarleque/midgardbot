...
module.exports =  {
    ...
    name: 'perfil',
    aliases: ['profile','pp'],
    description: '⭐ Muestra tu perfil o el de un usuario. Si eres usuario **VIP**, puedes editar el `Estado` y `Banner` de tu perfil agregando `-e` antes del estado que quieras y `-b` antes del link de alguna imagen o gif para tu banner.',
    use: '<prefix><name> [@user/id]\n_perfil -e <estado>\n_perfil -b <link de imagen>',
    category: 'Economía 💰',
    vip: false,
    owner: false,
                        ...
                        switch (obtener.slice(-2)){
                            ...
                            case '-b': {
                                ...
                                if(!args[1]){
                                    ...
                                    return message.reply({ embeds: [
                                        ...
                                        .setAuthor({ name: message.author.tag, iconURL: message.author.displayAvatarURL({ dynamic: true }) })
                                        .setColor('RED')
                                        .setDescription(`<a:Verify2:931463492677017650> | Ingrese un link de imagen o gif válido.`)
                                ...
                                if(!linkregex.test(args[1])){
                                    ...
                                    return message.reply({ embeds: [
                                        ...
                                        .setAuthor({ name: message.author.tag, iconURL: message.author.displayAvatarURL({ dynamic: true }) })
                                        .setColor('RED')
                                        .setDescription(`<a:Verify2:931463492677017650> | Link inválido! Ingrese un link de imagen o gif válido.`)
                            ...
                            default: {
                                ...
                                message.reply({ embeds: [
                                    ...
                                    .setAuthor({ name: message.author.tag, iconURL: message.author.displayAvatarURL({ dynamic: true }) })
                                    .setColor('RED')
                                    .setDescription(`<a:Verify2:931463492677017650> | Para actualizar tu Estado, agrega **-e** antes del texto. Para actualizar tu Banner, agrega **-b** antes del link de la imagen o gif.\n\n> Recuerda que solo los usuarios **VIP** pueden editar su perfil.`)
