...
module.exports =  {
    ...
    async execute(client, message, args, Discord) {
        ...
        .setFooter({ text: `${message.guild.name}• Muchas gracias por tu voto!`, iconURL: 'https://media.discordapp.net/attachments/880312288593195028/904603928375726120/Midgard_GIF_AVATAR.gif' })
