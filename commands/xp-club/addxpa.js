...
module.exports =  {
    ...
    use: '<prefix><name> <@user/id> <xpadicional>',
    category: 'XPCLUB 💎',
    vip: true,
    owner: true,
    ...
    async execute(client, message, args, Discord) {
        ...
        if(!args[1]) return message.reply({embeds: [
            ...
            .setAuthor({ name: message.author.tag, iconURL: message.author.displayAvatarURL() })
            .setColor('RED')
            .setDescription(`<a:Verify2:931463492677017650> | Ingresa el XP adicional que deseas agregar al Participante.`)
        ...
        try {
            ...
            if(!userxp){
                ...
                update.save()
                console.log('XP adicional de Participante Registrado ===> Id: '+ user1.id + ' - XP inicial: ' + userxp.xpinicial + ' - XP adicional: ' + xpa)
