    ...
    async execute(client, message, args, Discord) {
        ...
        try {
            ...
            if(!userxp){
                ...
                update.save()
                console.log('XP de Participante Registrado ===> Id: '+ user1.id + ' - XP inicial: ' + userxp.xpinicial + ' - SubTotal XP: ' + subtotal)
