module.exports =  {
    ...
    async execute(client, message, args, Discord) {
        ...
        if(!userm || userm.id === message.author.id) {
            ...
            .setAuthor('Información del Usuario', message.guild.iconURL({ dynamic: true }))
            .addField('Jugando a:', message.guild.members.resolve(userm.id).presence.activities[0].name ? message.guild.members.resolve(userm.id).presence.activities[0].name : 'Nada', true)
