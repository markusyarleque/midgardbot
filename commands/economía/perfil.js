        ...
        if(!img){
                ...
                if(!userData){
                    ...
                    if(!obtener){
                        ...
                        try {
                            ...
                            .addField('Rank', '<a:start:930399379800592394>  Nivel '+userData.nivel+' '+xp, true)
                            ...
                            .addField('Situación Sentimental <:GatoLove:925929538863628318>', tmarry ? tmarry : 'Soltero(a)', true)
            ...
            try {
                ...
                if (!userData){
                    ...
                    .setThumbnail(img.displayAvatarURL({ dynamic: true }))
                    .addField('Estado', '<a:megaphone:932192877449191424> '+userData.frase, false)
                    .addField('Rank', '<a:start:930399379800592394>  Nivel'+userData.nivel+' '+xp, true)
                    .addField('Carisma', '<a:corazon:930399275643453500> '+userData.rep, true)
                    .addField('Pats', '<a:gatoasomar:930399873113677834> '+userData.pat, true)
                    .addField('Abrazos', '<:burbujita:925927258789666826> '+userData.hug, true)
                    .addField('Sapes', '<:maje:925927838492811295> '+userData.sape, false)
                    .addField('Situación Sentimental <:GatoLove:925929538863628318> Matrimonio', tmarry ? tmarry : 'Soltero(a)', true)
